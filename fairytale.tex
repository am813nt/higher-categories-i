\chapter*{Introduction}
        ...
        \item 
            ...
            \begin{equation*}
                \begin{tikzcd}
                    ...
                    \arrow["{\color{red}{\text{cofibration} \longrightarrow}}"', hook, from=1-1, to=3-1]
                    \arrow["{\color{red}{\longleftarrow \text{fibration}}}", from=1-3, to=3-3]
    ...
    \begin{equation*}
        ...
        \end{tikzcd}        
    \end{equation*}    
    Warning: the actual definition requires the right hand vertical map to also be a Kan fibration!
