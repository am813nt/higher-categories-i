    ...
    \begin{enumerate}[label=\arabic*)]
        ...
        \begin{equation*}
            \begin{tikzcd}[column sep=scriptsize, row sep=scriptsize]
                ...
                & {} \\
                * && Y
                \arrow[color=magenta, from=1-1, to=1-3]
                \arrow[color=magenta, from=1-1, to=3-1]
                \arrow[color=magenta, from=1-1, to=3-3]
                \arrow[color=magenta, Rightarrow, from=1-3, to=2-2]
                \arrow["f", from=1-3, to=3-3]
                \arrow[color=magenta, Rightarrow, from=3-1, to=2-2]
...
\end{tikzcd}
    ...
    \begin{equation*}
        \begin{tikzcd}
            ...
            \overset{0}{\bullet} \arrow["\id"', loop, distance=2em, in=215, out=145] \arrow[r] & \overset{1}{\bullet} \arrow["\id"', loop, distance=2em, in=35, out=325] & {} \arrow[r, equal] & {\mathcal{N}[1]} \arrow[rd, magenta, maps to, shift right=15, swap, , "(0 \to 1)" at start, "\Delta^0 \overset{1}{\to} \mathrm{I}" at end] \arrow[ru, magenta, maps to, shift left=9, "0" at start, "0" at end] \arrow[ru, magenta, maps to, shift left=4, "1" at start, "2" at end] \arrow[ru, hook] \arrow[rd, magenta, maps to, shift right=11, , "1" at start, "2" at end] \arrow[rd, magenta, maps to, shift right=6, "0" at start, "0" at end] \arrow[rd, hook, shift right] &                                                   \\
