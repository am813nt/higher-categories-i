    ...
    \section{Examples}
        \begin{enumerate}[label=\roman*)]
            ...
            \item 
                ...
                \end{equation*}
                This also admits a categorical proof, but let us just observer that it gives a lax monoidal structure to the forgetful functor, and once you're done the exercise proving \ref{chIV-6-ii} it will unwind to give
                \begin{equation*}
